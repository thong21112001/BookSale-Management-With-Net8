...
//Toàn bộ đều ở trong link này: https://developer.paypal.com/api/rest/

namespace BookSale.Management.UI.Helpers
{
    //sealed: không cho kế thừa
    public sealed class PaypalClientHelper
    {
        //Phải giống với khai báo trong appsetting.json "PaypalCheckout"
        ...
        public PaypalClientHelper(string clientId, string clientSecret, string mode)
        {
            AppId = clientId;
        ...
        //Xác thực tài khoản sandbox trên paypal
        ...
        //Khởi tạo đơn hàng: https://developer.paypal.com/docs/api/orders/v2/#orders_create
